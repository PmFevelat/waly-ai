...
interface IntroAcceptModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  credits: number;
    ...
    <div 
      ...
      <div 
        ...
        <div className="p-4 border-b border-gray-200">
          <h2 className="text-base font-semibold text-gray-900">Accept Introduction</h2>
          <p className="text-xs text-gray-600 mt-1">
            Accept introduction from {contactName} at {company}
          </p>
        </div>
        ...
        <div className="p-4 text-center">
          ...
          <div className="text-xs text-gray-600 space-y-2">
            <p>
              <strong>{credits} credits</strong> will be spent immediately upon acceptance.
            </p>
          </div>
        </div>
